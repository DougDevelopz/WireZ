...
import dev.wirezbungee.commands.database.*;
import dev.wirezbungee.commands.systems.*;
...
public enum SubCommandTypes {
    ...
    THREAD_INFO("threadinfo", new ProxyThreadInfo()),
    THREAD_DUMP("threaddump", new ProxyThreadDump()),
